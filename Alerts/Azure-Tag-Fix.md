>[!alert] If <!--resource--> does not appear, it may be necessary to perform a manual refresh to force an update of the indexing in the Azure portal. To get <!--resource--> to appear, perform the following:
>
>
>
